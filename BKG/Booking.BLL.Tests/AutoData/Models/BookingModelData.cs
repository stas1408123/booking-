...
{
    internal static BookingModel GetBookingModelToUpdate = new()
    {
    ...
    public static List<BookingModel> SortedList(Guid hotelId, DateTime bookingFrom, DateTime bookingTo)
    {
